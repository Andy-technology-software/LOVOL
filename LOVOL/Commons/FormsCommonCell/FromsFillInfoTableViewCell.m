...
#import "FromsFillInfoTableViewCell.h"

#import "FormsCommonCellModel.h"
@interface FromsFillInfoTableViewCell()
...
@end
@implementation FromsFillInfoTableViewCell
...
- (void)textFieldDidEndEditing:(UITextField *)textField {
    [self.FromsFillInfoTableViewCellDelegate sendBackFormsFillValue:self.rowIndex AndSectionIndex:self.sectionIndex AndContent:textField.text];
}
