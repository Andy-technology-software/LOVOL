...
#import "CreditPendingViewController.h"

#import "SGSegmentedControl.h"

#import "CreditPendingAllViewController.h"
@interface CreditPendingViewController ()<UIScrollViewDelegate, SGSegmentedControlDelegate>
@property (nonatomic, strong) SGSegmentedControl *SG;
@property (nonatomic, strong) UIScrollView *mainScrollView;

@end

@implementation CreditPendingViewController
...
- (void)setupSegmentedControl {
    ...
    CreditPendingAllViewController *complainListVC = [[CreditPendingAllViewController alloc] init];
...
- (void)setupChildViewController {
    ...
    for (int i = 0; i<title_arr.count; i++) {
        CreditPendingAllViewController *oneVC = [[CreditPendingAllViewController alloc] init];
        oneVC.tagString = i;
