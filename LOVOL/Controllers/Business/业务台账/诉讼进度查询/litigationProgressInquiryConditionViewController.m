//
//  litigationProgressInquiryConditionViewController.m
//  LOVOL
//
...
@interface litigationProgressInquiryConditionViewController ()<UITableViewDelegate,UITableViewDataSource,FromsFillTableViewCellDelegate>
@property(nonatomic,strong)NSMutableArray* dataArr;

@end

@implementation litigationProgressInquiryConditionViewController
...
- (void)saveBtnClick {
    DLog(@"完成");
    [self.litigationProgressInquiryConditionViewControllerDelegate sendBackCzr:@""];
