...
//
//  TrailerProgressInquiryConditionViewController.m
//  LOVOL
//
...
@interface TrailerProgressInquiryConditionViewController ()<UITableViewDelegate,UITableViewDataSource,FromsFillTableViewCellDelegate,UIAlertViewDelegate>
@property(nonatomic,strong)NSArray* typeArr;
@property(nonatomic,strong)NSMutableArray* dataArr;

@end

@implementation TrailerProgressInquiryConditionViewController
...
- (void)viewDidLoad {
    ...
    //1是填的   2是选的
    self.typeArr = [[NSArray alloc] initWithObjects:@"2",@"1", nil];
    [self initUI];
    [self makeSaveBtn];
    [self makeRightNav];
    [self makeData];
 ...
 */
- (void)makeData {
    NSArray* leftArr = [[NSArray alloc] initWithObjects:@"查询类型",@"查询条件", nil];
    NSArray* placeArr = [[NSArray alloc] initWithObjects:@"请选择处理状态",@"请输入查询条件",nil];
