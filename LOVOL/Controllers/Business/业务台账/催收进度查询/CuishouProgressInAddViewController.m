...
//
//  CuishouProgressInAddViewController.m
//  LOVOL
//
...
#import "CuishouProgressInAddViewController.h"

#import "FormsCommonCellModel.h"

#import "FromsFillTableViewCell.h"
@interface CuishouProgressInAddViewController ()<UITableViewDelegate,UITableViewDataSource,FromsFillTableViewCellDelegate>
@property(nonatomic,strong)NSMutableArray* dataArr;

@end

@implementation CuishouProgressInAddViewController
 ...
 */
- (void)makeData {
    NSArray* leftArr = [[NSArray alloc] initWithObjects:@"逾期原因分类",@"逾期原因",@"还款承诺",@"履约情况", nil];
    NSArray* placeArr = [[NSArray alloc] initWithObjects:@"请输入逾期原因分类",@"请输入逾期原因",@"请输入还款承诺",@"请输入履约情况", nil];
