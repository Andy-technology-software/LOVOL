//
//  CuishouProgressInquiryContionViewController.m
//  LOVOL
//
...
#import "CuishouProgressInquiryContionViewController.h"

#import "FormsCommonCellModel.h"

#import "FromsFillTableViewCell.h"
@interface CuishouProgressInquiryContionViewController ()<UITableViewDelegate,UITableViewDataSource,FromsFillTableViewCellDelegate>
@property(nonatomic,strong)NSMutableArray* dataArr;

@end

@implementation CuishouProgressInquiryContionViewController
 ...
 */
- (void)makeData {
    NSArray* leftArr = [[NSArray alloc] initWithObjects:@"合同编号",@"承租人",@"经销商", nil];
    NSArray* placeArr = [[NSArray alloc] initWithObjects:@"请输入合同编号",@"请输入承租人",@"请输入经销商", nil];
...
- (void)saveBtnClick {
    DLog(@"完成");
    [self.CuishouProgressInquiryContionViewControllerDelegate sendBackHtbh:@"" czr:@"" jxs:@""];
