//
//  AgriculturalquipmentAddViewController.m
//  LOVOL
//
...
#import "AgriculturalquipmentAddViewController.h"
...
@interface AgriculturalquipmentAddViewController ()<UITableViewDelegate,UITableViewDataSource,FromsFillTableViewCellDelegate>
...
@implementation AgriculturalquipmentAddViewController
...
- (void)viewDidLoad {
    ...
    //1是填的   2是选的
    self.typeArr0 = [[NSArray alloc] initWithObjects:@"2",@"2",@"2",@"2",@"1",@"1",@"1",@"1", nil];
    [self initUI];
    [self makeAddBtn];
    [self makeData];
}
...
- (void)makeData {
    ...
    if (oldSavedArray0.count) {
        ...
        NSArray* leftArr0 = [[NSArray alloc] initWithObjects:@"租赁物类型",@"型号",@"出厂编号",@"发动机编号/电机编号",@"设备价款",@"成交单价",@"数量",@"备注", nil];
        NSArray* placeArr0 = [[NSArray alloc] initWithObjects:@"请选择租赁物类型",@"请扫描识别型号",@"请扫描识别出厂编号",@"请扫描识别发动机编号/点击编号",@"请输入设备价款",@"请输入成交单价",@"请输入数量",@"请输入备注", nil];
