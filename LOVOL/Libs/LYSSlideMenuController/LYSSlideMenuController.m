...
- (void)customBaseView
{
    CGFloat navHeight = [self superExistNav] ? [MyController isIOS7] : 0;
    CGFloat tabHeight = [self superExistTab] ? kTabBarHeight : 0;
    ...
    line.frame = Rect(0, CGRectGetMaxY(self.menuScrollView.frame), ScreenWidth, 6);
    line.backgroundColor = [MyController colorWithHexString:CViewF5Color];
