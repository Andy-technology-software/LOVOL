...
- (void)setTitleColorStateSelected:(UIColor *)titleColorStateSelected {
    ...
    for (UIView *subViews in self.titleBtn_mArr) {
        UIButton *button = (UIButton *)subViews;
        [button setTitleColor:[MyController colorWithHexString:CNavBgColor] forState:(UIControlStateSelected)];
    }
}

- (void)setIndicatorColor:(UIColor *)indicatorColor {
    _indicatorColor = indicatorColor;
    _indicatorView.backgroundColor = [MyController colorWithHexString:CNavBgColor];
}
