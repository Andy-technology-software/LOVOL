//
//  RentalPaymentTable10TableViewCell.m
//  LOVOL
//
...
@interface RentalPaymentTable10TableViewCell()
...
@end
@implementation RentalPaymentTable10TableViewCell
...
- (void)configCellWithModel:(RentalPaymentTable10Model *)model {
    self.qishuL.text = model._qishu;
    
    float titWidth = ([MyController getScreenWidth] - 40) / model.titA.count;
    for (int i = 0; i < model.titA.count; i++) {
