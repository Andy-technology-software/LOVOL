//
//  ImmediateApprovalTableViewCell.m
//  LOVOL
//
...
@interface ImmediateApprovalTableViewCell()<UITextViewDelegate>
@property (nonatomic, strong) UIView* bgView;

@end
@implementation ImmediateApprovalTableViewCell
...
{
    ImmediateApprovalTableViewCell *cell = [self dequeueReusableCellWithIdentifier:cellId];
    
    if (cell == NULL) {
        cell = [[ImmediateApprovalTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
